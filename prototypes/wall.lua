...
data:extend({
  {
    ...
    order = "a[stone-wall]-a[stone-wall]-t-arcane-stone-wall",
    ...
    place_result = "thaumfactory-arcane-stone-wall",
    stack_size = 100
  },
  {
    type = "wall",
    ...
    minable = { mining_time = 0.2, result = "thaumfactory-arcane-stone-wall" },
